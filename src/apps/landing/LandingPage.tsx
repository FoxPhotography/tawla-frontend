          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                a: "تقوم باختيار الباقة المناسبة والاشتراك معنا مباشرة بالدفع الإلكتروني الآمن (فواتيرك) أو عبر الواتساب. تمنحك المنصة 15 يوماً تجربة مجانية بالكامل للتحقق من جودة النظام."
              },
              {
      ...
      <section id="contact" className="relative bg-[#FAF8F5] py-24 px-6 text-center overflow-hidden border-t border-[#801B2C]/10">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center space-y-8">
          ...
          <p className="text-[#5C524C] text-[14.5px] max-w-lg mx-auto leading-relaxed">
            اشترك الآن بضمان تجربة مجانية لمدة 15 يوماً بالكامل، أو تواصل مع فريقنا لترتيب موعد تدريب مجاني لفريق العمل.
          </p>
