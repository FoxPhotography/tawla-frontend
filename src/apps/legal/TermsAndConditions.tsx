      ...
      <section className="space-y-3">
        ...
        <div className="space-y-3 text-sm text-[#4A4039]">
          ...
          <div className="p-4 rounded-2xl bg-[#FAF8F5] border border-[#801B2C]/10 space-y-2 text-xs">
            ...
            <p><strong>• ترقية وتغيير الباقات (Upgrades & Plan Changes):</strong> يحق للمشترك ترقية أو تخفيض أو تغيير باقته في أي وقت. عند سداد الباقة الجديدة، تبدأ فترة وصلاحية الباقة المختارة فوراً من تاريخ السداد، ويتم استبدال وإلغاء أي مدة أو أيام متبقية من باقته السابقة تلقائياً دون استحقاق أي استرداد مالي أو تعويض عن الفترة المنقضية أو المتبقية.</p>
