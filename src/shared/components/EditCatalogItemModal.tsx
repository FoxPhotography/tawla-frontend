    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm overflow-y-auto" dir="rtl">
        <motion.div
          ...
          className="bg-[#121214] border border-zinc-800 rounded-2xl w-full max-w-3xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden text-right text-zinc-100"
        >
          {/* Header */}
          <div className="p-5 border-b border-zinc-800/80 flex items-center justify-between bg-zinc-900/50">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#801B2C]/20 border border-[#801B2C]/40 text-[#801B2C] flex items-center justify-center">
          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800/80 flex flex-col sm:flex-row items-center gap-5">
              <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-xl bg-zinc-800 border border-zinc-700/80 overflow-hidden flex-shrink-0 relative group">
                {imagePreview ? (
                  <img
                    src={imagePreview}
                    alt="Preview"
              ...
              <div className="flex-1 space-y-2 text-center sm:text-right w-full">
                <div className="text-xs font-bold text-zinc-200">صورة الصنف الحقيقية (Studio Photo)</div>
                <p className="text-[11px] text-zinc-400">
                  يمكنك رفع صورة من جهازك، وسيتم تحسينها وضغطها تلقائياً بصيغة WebP خفيفة (800x800).
                </p>
                ...
                <div className="flex flex-wrap items-center gap-2 pt-1">
                  ...
                  {imageFile && (
                    <span className="text-[11px] text-emerald-400 font-bold bg-emerald-950/40 border border-emerald-800/60 px-2.5 py-1 rounded-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3.5 py-2 rounded-xl bg-zinc-900 border border-zinc-700 text-sm text-white focus:outline-none focus:border-[#801B2C] transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl bg-zinc-900 border border-zinc-700 text-sm text-white focus:outline-none focus:border-[#801B2C] transition-colors text-left"
                  dir="ltr"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="50"
                  required
                  className="w-full px-3.5 py-2 rounded-xl bg-zinc-900 border border-zinc-700 text-sm text-white focus:outline-none focus:border-[#801B2C] transition-colors font-mono"
                />
              </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`py-2 px-3 rounded-xl text-xs font-bold flex items-center justify-center gap-2 border transition-all ${
                      categoryType === 'cafe'
                        ? 'bg-[#801B2C] text-white border-[#801B2C]'
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2 rounded-xl bg-zinc-900 border border-zinc-700 text-sm text-white focus:outline-none focus:border-[#801B2C] transition-colors leading-relaxed resize-none"
              />
            </div>
            ...
            <div className="p-4 rounded-xl bg-zinc-900/40 border border-zinc-800 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-xs px-3 py-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-zinc-200 font-bold transition-colors flex items-center gap-1.5"
                >
              ...
              {options.length === 0 ? (
                <div className="py-4 text-center text-xs text-zinc-500 font-medium border border-dashed border-zinc-800 rounded-lg">
                ...
                <div className="space-y-3">
                  {options.map((opt, gIdx) => (
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div className="flex-1 flex items-center gap-2">
                          <input
                            ...
                            className="flex-1 px-3 py-1.5 rounded-lg bg-zinc-800 border border-zinc-700 text-xs text-white focus:outline-none focus:border-[#801B2C]"
                          />
                      ...
                      {/* Choices */}
                      <div className="space-y-1.5 pr-3 border-r-2 border-zinc-800">
                        {opt.choices.map((c, cIdx) => (
                          <div key={cIdx} className="flex items-center gap-2">
                            <input
                              ...
                              className="flex-1 px-2.5 py-1 rounded-lg bg-zinc-800/80 border border-zinc-700/80 text-xs text-white"
                            />
                            <div className="flex items-center gap-1 w-28">
                              ...
                              <input
                                ...
                                placeholder="0"
                                className="w-full px-2 py-1 rounded-lg bg-zinc-800/80 border border-zinc-700/80 text-xs text-white font-mono text-center"
                              />
                              <span className="text-[10px] text-zinc-400 font-bold">ج.م</span>
                            </div>
                            <button
                              type="button"
                        ...
                        <button
                          ...
                          className="text-[11px] text-red-400 hover:text-red-300 font-bold flex items-center gap-1 pt-1"
                        >
            ...
            <div className="pt-4 border-t border-zinc-800 flex items-center justify-between gap-3">
              <div>
                {isEditing && (
                  <button
                    ...
                    className="px-3.5 py-2 rounded-xl bg-red-950/40 hover:bg-red-900/60 border border-red-800/50 text-red-400 text-xs font-bold flex items-center gap-1.5 transition-colors"
                  >
                    <Trash2 className="w-3.5 h-3.5" />
              ...
              <div className="flex items-center gap-2.5">
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="px-5 py-2 rounded-xl bg-[#801B2C] hover:bg-[#9a2135] text-white text-xs font-black shadow-lg shadow-[#801B2C]/30 flex items-center gap-2 transition-all disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
